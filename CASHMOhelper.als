...
//	all s : State, c : Client |
//	( c.bank = s.empty or c.bank = s.sufficient ) and ( c.account = s.empty or c.account = s.sufficient )
//}
...
//fact implications {
//	all e : State.empty, f : State.full, n: State.notSufficient, s: State.sufficient, c: Client |
//	(c.account = e implies c.account = n) and (c.account = s implies c.account = f)
//	and (c.bank = e implies c.bank = n) and (c.bank = s implies c.bank = f)
//}
